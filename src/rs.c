 ...
 *
 * Computes the syndrome of a codeword. Puts the results into the \ref synBytes[] array.
 *
 ...
 * Make sure that the genPoly array which is passed in is at least n+1 bytes long.
 */
static void compute_genpoly(int nbytes, int genpoly[]) {
